 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_GetInterruptMask(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_GetInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_EnableInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_DisableInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_ClearInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_EnableBaseband(deviceID, CMT_PDD_BASEBAND_DISABLED);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_SelectFskMode(deviceID, CMT_PDD_MODE_TIME_BASEBAND);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_EnableExtendedSpace(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_EnableDevice(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_GetEnableDeviceStatus(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_SetDivider(deviceID, CMT_PDD_DIVIDER_1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_SetPrescaler(deviceID, CMT_PDD_PRESCALER_1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_EnableIroPin(deviceID, CMT_PDD_PIN_DISABLED);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_SetPolarity(deviceID, CMT_PDD_POLARITY_LOW);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_SetLatch(deviceID, CMT_PDD_LATCH_LOW);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteHighData1Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_ReadHighData1Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteLowData1Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_ReadLowData1Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteHighData2Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_ReadHighData2Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteLowData2Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = CMT_PDD_ReadLowData2Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteMarkHighReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteMarkLowReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteSpaceHighReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      CMT_PDD_WriteSpaceLowReg(deviceID, 1);
 *      @endcode
 */
