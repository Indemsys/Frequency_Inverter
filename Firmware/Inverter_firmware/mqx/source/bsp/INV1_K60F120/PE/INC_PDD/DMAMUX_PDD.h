 ...
 * @par Example:
 *      @code
 *      DMAMUX_PDD_WriteChannelConfigurationReg(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = DMAMUX_PDD_ReadChannelConfigurationReg(deviceID,
 *      periphID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      DMAMUX_PDD_EnableChannel(deviceID, periphID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = DMAMUX_PDD_GetChannelEnabled(deviceID, periphID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      DMAMUX_PDD_EnableTrigger(deviceID, periphID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = DMAMUX_PDD_GetTriggerEnabled(deviceID, periphID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      DMAMUX_PDD_SetChannelSource(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = DMAMUX_PDD_GetChannelSource(deviceID, periphID);
 *      @endcode
 */
