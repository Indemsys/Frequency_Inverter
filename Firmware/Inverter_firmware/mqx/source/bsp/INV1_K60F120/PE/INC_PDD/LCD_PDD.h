 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableRegulatedVoltage(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetRegulatedVoltageTrim(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetLoadAdjust(deviceID, LCD_PDD_LOW_LOAD_RESISTOR_NET);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetVoltageSupplyControl(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableInterrupts(deviceID, LCD_PDD_FAULT_DETECT_COMPLETE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableInterrupts(deviceID, LCD_PDD_FRAME_FREQUENCY);
 *      @endcode
 */
  #define LCD_PDD_EnableInterrupts(PeripheralBase, Mask) ( \
      LCD_GCR_REG(PeripheralBase) = \
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_DisableInterrupts(deviceID, LCD_PDD_FAULT_DETECT_COMPLETE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_DisableInterrupts(deviceID, LCD_PDD_FRAME_FREQUENCY);
 *      @endcode
 */
  #define LCD_PDD_DisableInterrupts(PeripheralBase, Mask) ( \
      LCD_GCR_REG(PeripheralBase) &= \
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetAlternateClkDivider(deviceID, LCD_PDD_DIVIDE_FACTOR_1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableInWaitMode(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableInStopMode(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableDevice(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetClkSource(deviceID, LCD_PDD_DEFAULT_CLK);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetClkPrescaler(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetDutyCycle(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LCD_PDD_GetFrameFreqInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_ClearFrameFreqInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableBlinking(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableAlternateMode(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableBlankDisplayMode(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetBlinkMode(deviceID, LCD_PDD_BLANK_BLINK);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetBlinkRate(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetFaultDetectClkPrescaler(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetFaultDetectSampleWidth(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableFaultDetect(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetFaultDetectPinType(deviceID, LCD_PDD_FAULT_FRONTPLANE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetFaultDetectPinID(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LCD_PDD_GetFaultDetectInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_ClearFaultDetectInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = LCD_PDD_GetFaultDetectValue(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnablePinMask(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetPinAsBackplaneMask(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetWaveform(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = LCD_PDD_GetWaveform(deviceID, periphID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SetAlternateWaveform(deviceID, periphID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = LCD_PDD_GetAlternateWaveform(deviceID, periphID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_EnableFastFrameRate(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LCD_PDD_SelectAlternateClkSource(deviceID, LCD_PDD_CLK1);
 *      @endcode
 */
