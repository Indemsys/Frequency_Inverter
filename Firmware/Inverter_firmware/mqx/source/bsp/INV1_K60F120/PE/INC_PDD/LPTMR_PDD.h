 ...
 * @par Example:
 *      @code
 *      uint32_t result = LPTMR_PDD_GetInterruptMask(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LPTMR_PDD_GetInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_EnableInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_DisableInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_ClearInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SelectPin(deviceID, LPTMR_PDD_HSCMP);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SetPinPolarity(deviceID, LPTMR_PDD_POLARITY_RISING);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_EnableFreerun(deviceID, LPTMR_PDD_RESTART_ENABLED);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SetTimerMode(deviceID, LPTMR_PDD_SOURCE_INTERNAL);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_EnableDevice(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LPTMR_PDD_GetEnableDeviceStatus(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SetPrescaler(deviceID, LPTMR_PDD_PRESCALER_2);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_EnablePrescalerBypass(deviceID, LPTMR_PDD_BYPASS_DISABLED);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SetDivider(deviceID, LPTMR_PDD_DIVIDER_1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_SelectPrescalerSource(deviceID, LPTMR_PDD_SOURCE_INTREF);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      LPTMR_PDD_WriteCompareReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LPTMR_PDD_ReadCompareReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = LPTMR_PDD_ReadCounterReg(deviceID);
 *      @endcode
 */
