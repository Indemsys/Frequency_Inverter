 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadCMD1Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteCMD1Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadCMD2Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteCMD2Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadCARReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteCARReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadRARReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteRARReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadRPTReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteRPTReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadRAIReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteRAIReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadSR1Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = NFC_PDD_GetID1(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = NFC_PDD_GetID2(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = NFC_PDD_GetID3(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = NFC_PDD_GetID4(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadSR2Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint8_t result = NFC_PDD_GetID5(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadDMA1Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteDMA1Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadSWAPReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteSWAPReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadSECSZReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteSECSZReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadCFGReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteCFGReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadDMA2Reg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteDMA2Reg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_ReadISRReg(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_WriteISRReg(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_GetInterruptFlags(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_ClrInterruptFlags(deviceID, NFC_PDD_WERR_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_EnableInterrupt(deviceID, NFC_PDD_WERR_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_DisableInterrupt(deviceID, NFC_PDD_WERR_INT);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_EnableWriteErrorInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_DisableWriteErrorInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_GetWriteErrorInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_ClrWriteErrorInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_EnableCmdDoneInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_DisableCmdDoneInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_GetCmdDoneInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_ClrCmdDoneInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_EnableCmdIdleInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_DisableCmdIdleInterrupt(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_GetCmdIdleInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_ClrCmdIdleInterruptFlag(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetFastFlashTiming(deviceID, PDD_DISABLE);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetEccModeDmaAndVirtPageCount(deviceID, NFC_PDD_ECC_0_ERR,
 *      NFC_PDD_DMA_NO, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetSectorSize(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetVirtualPageCount(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetRowAddress(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_IncRowAddress(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetColAddress(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      uint32_t result = NFC_PDD_GetRepeatCount(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetRepeatCount(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetRowAddressInc(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetDma1Address(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetDma2Address(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetDma1AndDma2(deviceID, 1, 1, 1, 1, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetReadIdCmd(deviceID, 1, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetReadPageCmd(deviceID, 1, 1, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetWritePageCmd(deviceID, 1, 1, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetEraseBlockCmd(deviceID, 1);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetEccModeDmaReqAndPageCount(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_DisableAddressSwap(deviceID);
 *      @endcode
 */
 ...
 * @par Example:
 *      @code
 *      NFC_PDD_SetAddressSwap(deviceID, 1, 1);
 *      @endcode
 */
